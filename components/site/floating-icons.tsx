...
const ICONS: Array<{
  ...
  { id: "bee1",     Icon: IconBee,        size: 36, x: "7%",  y: "1%",  color: "#f5a623", anim: styles.float2,    dur: "7.5s",  delay: "0.3s"  },
  { id: "pear1",    Icon: IconPear,       size: 44, x: "88%", y: "2%",  color: "#84cc16", anim: styles.float3,    dur: "8.2s",  delay: "1.8s"  },
  { id: "bird1",    Icon: IconBird,       size: 40, x: "44%", y: "3%",  color: "#52aeff", anim: styles.float1,    dur: "9.5s",  delay: "0.8s"  },
  { id: "plum1",    Icon: IconPlum,       size: 38, x: "23%", y: "5%",  color: "#9333ea", anim: styles.float4,    dur: "7s",    delay: "2.3s"  },
  { id: "btf1",     Icon: IconButterfly,  size: 42, x: "67%", y: "6%",  color: "#d44fa3", anim: styles.floatSpin, dur: "10s",   delay: "1.2s"  },
  { id: "fig1",     Icon: IconFig,        size: 40, x: "3%",  y: "13%", color: "#8b5cf6", anim: styles.float3,    dur: "8.8s",  delay: "0.5s"  },
  { id: "flower1",  Icon: IconFlower,     size: 46, x: "78%", y: "14%", color: "#f87171", anim: styles.float1,    dur: "9s",    delay: "3.1s"  },
  { id: "cherry1",  Icon: IconCherries,   size: 44, x: "52%", y: "17%", color: "#c0392b", anim: styles.float2,    dur: "7.8s",  delay: "1.6s"  },
  { id: "sprout1",  Icon: IconSprout,     size: 38, x: "31%", y: "20%", color: "#5aaa28", anim: styles.float4,    dur: "8.5s",  delay: "0s"    },
  { id: "peach1",   Icon: IconPeach,      size: 42, x: "93%", y: "22%", color: "#f97316", anim: styles.float3,    dur: "6.5s",  delay: "2.8s"  },
  { id: "bb1",      Icon: IconBlackberry, size: 40, x: "13%", y: "27%", color: "#7c3aed", anim: styles.float1,    dur: "9.2s",  delay: "1.4s"  },
  { id: "bamboo1",  Icon: IconBamboo,     size: 44, x: "62%", y: "28%", color: "#5a9e3c", anim: styles.float2,    dur: "8s",    delay: "0.7s"  },
  { id: "lady1",    Icon: IconLadybug,    size: 36, x: "85%", y: "32%", color: "#e33333", anim: styles.float4,    dur: "7.2s",  delay: "3.5s"  },
  { id: "clover1",  Icon: IconClover,     size: 42, x: "37%", y: "35%", color: "#3cb879", anim: styles.float3,    dur: "10.5s", delay: "2s"    },
  { id: "persist1", Icon: IconPersimmon,  size: 40, x: "5%",  y: "37%", color: "#ea580c", anim: styles.floatSpin, dur: "8.5s",  delay: "1s"    },
  { id: "bee2",     Icon: IconBee,        size: 32, x: "72%", y: "40%", color: "#f5a623", anim: styles.float1,    dur: "6.8s",  delay: "4.1s"  },
  { id: "pear2",    Icon: IconPear,       size: 36, x: "20%", y: "43%", color: "#84cc16", anim: styles.float2,    dur: "9.8s",  delay: "0.4s"  },
  { id: "wcan1",    Icon: IconWateringCan,size: 46, x: "48%", y: "46%", color: "#4bb8a8", anim: styles.float3,    dur: "7.5s",  delay: "2.6s"  },
  { id: "bird2",    Icon: IconBird,       size: 38, x: "89%", y: "49%", color: "#52aeff", anim: styles.float4,    dur: "11s",   delay: "1.9s"  },
  { id: "fig2",     Icon: IconFig,        size: 34, x: "9%",  y: "51%", color: "#8b5cf6", anim: styles.float1,    dur: "8.2s",  delay: "3.7s"  },
  { id: "cherry2",  Icon: IconCherries,   size: 40, x: "56%", y: "54%", color: "#c0392b", anim: styles.float2,    dur: "7s",    delay: "0.2s"  },
  { id: "flower2",  Icon: IconFlower,     size: 44, x: "28%", y: "57%", color: "#f87171", anim: styles.floatSpin, dur: "9.5s",  delay: "1.3s"  },
  { id: "plum2",    Icon: IconPlum,       size: 38, x: "78%", y: "60%", color: "#9333ea", anim: styles.float3,    dur: "8.8s",  delay: "2.1s"  },
  { id: "sprout2",  Icon: IconSprout,     size: 42, x: "4%",  y: "63%", color: "#5aaa28", anim: styles.float4,    dur: "7.8s",  delay: "0.9s"  },
  { id: "peach2",   Icon: IconPeach,      size: 36, x: "43%", y: "65%", color: "#f97316", anim: styles.float1,    dur: "6.2s",  delay: "3.3s"  },
  { id: "bb2",      Icon: IconBlackberry, size: 44, x: "91%", y: "68%", color: "#7c3aed", anim: styles.float2,    dur: "10.2s", delay: "1.7s"  },
  { id: "btf2",     Icon: IconButterfly,  size: 40, x: "17%", y: "71%", color: "#d44fa3", anim: styles.float3,    dur: "8s",    delay: "4.4s"  },
  { id: "bamboo2",  Icon: IconBamboo,     size: 38, x: "64%", y: "74%", color: "#5a9e3c", anim: styles.floatSpin, dur: "9s",    delay: "0.6s"  },
  { id: "lady2",    Icon: IconLadybug,    size: 34, x: "35%", y: "77%", color: "#e33333", anim: styles.float4,    dur: "7.5s",  delay: "2.9s"  },
  { id: "persist2", Icon: IconPersimmon,  size: 42, x: "82%", y: "79%", color: "#ea580c", anim: styles.float1,    dur: "8.5s",  delay: "1.1s"  },
  { id: "clover2",  Icon: IconClover,     size: 40, x: "6%",  y: "82%", color: "#3cb879", anim: styles.float2,    dur: "9.2s",  delay: "3.6s"  },
  { id: "wcan2",    Icon: IconWateringCan,size: 44, x: "50%", y: "85%", color: "#4bb8a8", anim: styles.float3,    dur: "7.2s",  delay: "0.3s"  },
  { id: "bee3",     Icon: IconBee,        size: 38, x: "73%", y: "88%", color: "#f5a623", anim: styles.float1,    dur: "8s",    delay: "2.2s"  },
  { id: "flower3",  Icon: IconFlower,     size: 46, x: "25%", y: "91%", color: "#f87171", anim: styles.float4,    dur: "10s",   delay: "1.5s"  },
  { id: "cherry3",  Icon: IconCherries,   size: 42, x: "92%", y: "93%", color: "#c0392b", anim: styles.floatSpin, dur: "8.8s",  delay: "0.8s"  },
];
