...
const ICONS: Array<{
  ...
  { id: "w1", Icon: IconWheat, size: 52, x: "6%",  y: "7%",  color: "#22c55e", anim: styles.float1,    dur: "6.5s", delay: "0s"   },
  { id: "s1", Icon: IconSun,   size: 64, x: "78%", y: "5%",  color: "#4ade80", anim: styles.floatSpin, dur: "9s",   delay: "1.3s" },
  { id: "l1", Icon: IconLeaf,  size: 44, x: "22%", y: "18%", color: "#16a34a", anim: styles.float2,    dur: "7.5s", delay: "0.7s" },
  { id: "d1", Icon: IconDrop,  size: 38, x: "60%", y: "11%", color: "#86efac", anim: styles.float3,    dur: "5.8s", delay: "2.1s" },
  { id: "w2", Icon: IconWheat, size: 46, x: "87%", y: "32%", color: "#15803d", anim: styles.float2,    dur: "7s",   delay: "1.9s" },
  { id: "c1", Icon: IconCorn,  size: 48, x: "44%", y: "7%",  color: "#22c55e", anim: styles.float4,    dur: "8.2s", delay: "0.4s" },
  { id: "l2", Icon: IconLeaf,  size: 36, x: "12%", y: "44%", color: "#4ade80", anim: styles.float1,    dur: "9.5s", delay: "3.2s" },
  { id: "s2", Icon: IconSun,   size: 34, x: "54%", y: "38%", color: "#bbf7d0", anim: styles.floatSpin, dur: "7s",   delay: "1.1s" },
  { id: "w3", Icon: IconWheat, size: 40, x: "34%", y: "52%", color: "#16a34a", anim: styles.float3,    dur: "8.5s", delay: "2.6s" },
  { id: "d2", Icon: IconDrop,  size: 32, x: "71%", y: "48%", color: "#86efac", anim: styles.float2,    dur: "6s",   delay: "0.9s" },
  { id: "c2", Icon: IconCorn,  size: 38, x: "91%", y: "15%", color: "#22c55e", anim: styles.float1,    dur: "8s",   delay: "2s"   },
  { id: "l3", Icon: IconLeaf,  size: 58, x: "2%",  y: "24%", color: "#15803d", anim: styles.float4,    dur: "11s",  delay: "1.5s" },
  { id: "w4", Icon: IconWheat, size: 36, x: "65%", y: "24%", color: "#4ade80", anim: styles.float3,    dur: "7.2s", delay: "3.8s" },
  { id: "s3", Icon: IconSun,   size: 28, x: "37%", y: "34%", color: "#bbf7d0", anim: styles.floatSpin, dur: "6.8s", delay: "0.2s" },
  { id: "d3", Icon: IconDrop,  size: 30, x: "49%", y: "58%", color: "#86efac", anim: styles.float1,    dur: "7.5s", delay: "4s"   },
];
